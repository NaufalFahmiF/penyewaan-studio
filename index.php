...
<div id="carouselId" class="carousel slide" data-ride="carousel">
    <ol class="carousel-indicators">
        <?php 
            $querystudio =  $koneksi -> query('SELECT * FROM studio ORDER BY id_studio DESC')->fetchAll();
            $no =1;
            foreach($querystudio as $isi)
            {
        ?>
...
<div class="container-fluid mt-5">
    <div class="row">
        ...
        <div class="col-sm-9">
            <div class="row">
                <?php 
                    $query =  $koneksi -> query('SELECT * FROM studio ORDER BY id_studio DESC')->fetchAll();
                    $no =1;
                ...
                <div class="col-sm-4">
                    ...
                    <img src="assets/image/<?php echo $isi['gambar'];?>" class="card-img-top" style="height:200px;">
                        ...
                        <h5 class="card-title"><?php echo $isi['jenis'];?></h5>
                        </div>
                        ...
                        <li class="list-group-item bg-info text-white"><i class="fa fa-check"></i> Free Minum</li>
                        <li class="list-group-item bg-dark text-white">
                            <i class="fa fa-money"></i> Rp. <?php echo number_format($isi['harga']);?> / Jam
                        </li>
                        </ul>
                        <div class="card-body">
                        <center><a href="booking.php?id=<?php echo $isi['id_studio'];?>" class="btn btn-success">Booking now!</a>
                        <a href="detail.php?id=<?php echo $isi['id_studio'];?>" class="btn btn-info">Detail</a></center>
                        </div>
                    </div>
                </div>
                <?php $no++;}?>
