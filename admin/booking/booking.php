<?php
    ...
    if(!empty($_GET['id'])){
        ...
        $sql = "SELECT studio.jenis, booking.* FROM booking JOIN studio ON 
                booking.id_studio=studio.id_studio WHERE id_login = '$id' ORDER BY id_booking DESC";
    }else{
        $sql = "SELECT studio.jenis, booking.* FROM booking JOIN studio ON 
                booking.id_studio=studio.id_studio ORDER BY id_booking DESC";
    }
