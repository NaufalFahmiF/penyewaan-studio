<?php
    ...
    if(!empty($_GET['id'])){
        ...
        $id = $hasil['id_studio'];
        $isi = $koneksi->query("SELECT * FROM studio WHERE id_studio = '$id'")->fetch();
    }
...
<div class="row">
    ...
    <div class="col-sm-8">
         <div class="card">
            <div class="card-header">
                <h5 class="card-title">Detail Booking & Status Studio</h5>
            </div>
           <div class="card-body">
               <form method="post" action="./proses_pinjam.php?id=konfirmasi">
                    <table class="table">
                        <tr>
                            <td>Kode Booking  </td>
                            <td> :</td>
                    ...
                    <input type="hidden" name="id_studio" value="<?php echo $isi['id_studio'];?>">
