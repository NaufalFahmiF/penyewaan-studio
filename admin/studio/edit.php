                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                ...
                                <input type="text" class="form-control col-sm-9" value="<?= $hasil['no_studio'];?>" name="no_studio" placeholder="Isi No Plat">
                            </div>

                            <div class="form-group row">
                                <label class="col-sm-3">Jenis Studio</label>
                                <input type="text" class="form-control col-sm-9"  value="<?= $hasil['jenis'];?>" name="jenis" placeholder="Isi jenis">
                            </div>
