...
<html lang="en">
  <head>
    <title><?php echo $title_web;?> | Sewa Studio</title> 
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body>
    <div class="jumbotron pt-4 pb-4">
        <div class="row">
            <div class="col-sm-8">
                <h2><b style="text-transform:uppercase;">Studio Semesta </b></h2>
            </div>
        </div>
    </div>
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item <?php if($title_web == 'User'){ echo 'active';}?>">
                    <a class="nav-link" href="<?php echo $url;?>admin/user.php">User / Pelanggan</a>
                </li>
                ...
                <?php if($title_web == 'Edit studio'){ echo 'active';}?>">
                    <a class="nav-link" href="<?php echo $url;?>admin/studio/studio.php">Daftar Studio</a>
                </li>
                ...
                <li class="nav-item <?php if($title_web == 'Peminjaman'){ echo 'active';}?>">
                    <a class="nav-link" href="<?php echo $url;?>admin/peminjaman.php">Peminjaman / Pengembalian</a>
                </li>
            </ul>
